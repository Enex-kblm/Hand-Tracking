...
while True:
    ...
    if len(handLandMarks) !=0:
        ...
        x8,y8 = handLandMarks[20][1],handLandMarks[20][2]
        ...
        cv2.putText(frame, f'testing = {int(vol_perc)} % ',(18,110),cv2.FONT_HERSHEY_COMPLEX, 0.6 ,(0,0,255),2)

    cv2.imshow("ht by galih",frame)
